...
function show() {
  ...
  xmlhttp.open("GET","viewauction.php",true);
  xmlhttp.send();
}
...
function show_cond() {
  ...
  xmlhttp.open("GET","viewauction_cond.php",true);
  xmlhttp.send();
}
</script>
</head>
...
<div id="container">  
  ...
  <div id="content">
    ...
    <div class="nav-bar">
      ...
      <div class="function-board" style="padding-left:21em;">
          
<input type="submit" class="btn btn-primary"  value="Home" onclick="window.location='index.php';" />
<input type="submit"  class="btn btn-primary"  value="View Auctions" onclick="show()" />
<input type="submit" class="btn btn-success"  value="Add New Auction" onclick="window.location='addauction.php';" />
