...
<body>
  ...
  <div id="content" style="height:40em;">
    <div  class="title-txt">
   
    </div>
    <div class="nav-bar">
      <input type="submit" class="btn btn-primary btn-lg" style="margin-left:6.5em; margin-top:2em;"value="Back" onclick="window.location='index.php';" />
     	<?php

	echo '<div class="oops" ><span class="glyphicon glyphicon-exclamation-sign ctrl" style="padding-right:30px;"></span>Access Denied!</div>';
