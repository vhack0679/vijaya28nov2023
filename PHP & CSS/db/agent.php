  ...
  <div id="content">
    ...
    <div class="nav-bar">
      ...
      <div class="function-board">
          ...
          <input type="submit" class="btn btn-primary" value="View Agents" onclick="show()" />
          
          <input type="submit" class="btn btn-primary" value="Update Agent" onclick="window.location='updagent.php';" />
          <input type="submit" class="btn btn-success" value="Add New Agent" onclick="window.location='addagent.php';" />
